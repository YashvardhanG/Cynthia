...
def assistant(command):
        ...
        if 'open google' in command:
            ...
            print('I am very good!')
                ...
                owm = pyowm.OWM('93a6692a607d22b4068d2874e34cb03d')
                place=input("Enter the (State,Country):")
                ...
                n=int(input("The number of numbers you want to add:"))
                sum=0
                while n>0:
                        num=int(input("Enter the number:"))
                        sum+=num
                        n-=1
                print("The addition of the numbers is:",sum)
                        
        elif 'subtraction' in command:
                n=int(input("The number of numbers you want to subtract:"))
                ...
                n=int(input("The number of numbers you want to multiply:"))
                mul=1
                while n>0:
                        num=int(input("Enter the number:"))
                        mul*=num
                ...
                n=int(input("The number of numbers you want to divide:"))
                ...
                print("What do you want to find out?\nEnter the trigonometric function itself (Eg: sin)\n1.)sin\n2.)cos\n3.)tan\n")
                a=input("Enter the function you want to perform:")
                if a=='sin':
                        x=int(input("Enter whose sin you want to evaluate (in degrees):"))
                        func=math.radians(x)
                        ans=math.sin(func)
                        print("The value of sin(",x,") is:",ans)

                elif a=='cos':
                        x=int(input("Enter whose cos you want to evaluate (in degrees):"))
                        func=math.radians(x)
                        ans=math.cos(func)
                        print("The value of cos(",x,") is:",ans)

                elif a=='tan':
                        x=int(input("Enter whose tan you want to evaluate (in degrees):"))
                        func=math.radians(x)
                        ans=math.tan(func)
                        print("The value of tan(",x,") is:",ans)
                ...
                print("Use this app for solving complex equations")
            ...
            sys.exit()
                ...
                print("To open any application on your computer just enter its name but, please make sure that you ensure the actual file name")
                print("For eg: To open google chrome, type in ""chrome"" and not ""google chrome"", otherwise the assistant will close itself")
                app=input("Enter the name of the application you want to open:")
                ...
                print("Welcome to the calculator",your_name,":")
                print("To perform the function, input the name of the function in the command:")
                print("1.)Addition\n2.)Subtraction\n3.)Multiplication\n4.)Division\n5.)Trignometric functions (tf)\n6.)Complex Functions (cf)\n")
